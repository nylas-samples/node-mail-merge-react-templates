...
// TODO: ContactDetail
// we should add more details to specific contacts from mock data
function EmailDetail({
  ...
  // console.log(selectedContact && selectedContact.emails[0].email)
    ...
    <div className="email-detail-view">
      ...
      {selectedContact ? (
        <div className="selected">
          ...
          <h3 className="title"><strong>Client:</strong> {`${selectedContact.given_name} ${selectedContact.surname}` || '(no subject)'}</h3>
          ...
          <span className="sender-email"><strong>Last Visit:</strong> {new Date(selectedContact.last_visit_date * 1000).toLocaleDateString("en-US")}</span>
          <span className="sender-email"><strong>Last Service:</strong> {selectedContact.service_completed_recently}</span>
          <span className="sender-email"><strong>Appointment Day Preference:</strong> {selectedContact.preferred_appointment}</span>
          {/* <span className="sender-email"><strong>Email:</strong> {selectedContact.emails[0].email}</span> */}
        ...
        <div className="empty-email">
          ...
          <p>1. Click `Send Email Template`</p>
          {/* <p>2. Select an Email Template to Preview</p> */}
          <p>2. Preview Template with different Contacts</p>
          <p>3. Select and send to all contacts</p>
        </div>
      )}
    </div>
  );
